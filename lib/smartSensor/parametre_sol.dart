...
class parametresol extends StatefulWidget {
  const parametresol({Key? key}) : super(key: key);

  @override
  State<parametresol> createState() => _parametresolState();
}

class _parametresolState extends State<parametresol> {
